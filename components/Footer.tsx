...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#faf5f6]">
      {/* Newsletter */}
      <div className="flex flex-col items-center py-14 px-6">
        <p className="mb-5 text-sm text-gray-700 tracking-wide">sign up for updates:</p>
        <form
      ...
      <div className="flex justify-center gap-6 pb-8">
        <a href="#" aria-label="Facebook" className="text-gray-500 hover:text-gray-800 transition">
          <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
            <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z" />
          </svg>
        </a>
        <a href="#" aria-label="Instagram" className="text-gray-500 hover:text-gray-800 transition">
          <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <a href="#" aria-label="Twitter" className="text-gray-500 hover:text-gray-800 transition">
          <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
            <path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z" />
          </svg>
        </a>
        <a href="#" aria-label="TikTok" className="text-gray-500 hover:text-gray-800 transition">
          <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="flex flex-wrap justify-center gap-x-5 gap-y-2 px-6 pb-4">
          {legalLinks.map((link) => (
            <a
              key={link}
              href="#"
              className="text-[12px] text-gray-500 underline hover:text-gray-700 transition"
            >
              {link}
            </a>
          ))}
