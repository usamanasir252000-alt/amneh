...
// they only discover at checkout. Static text, not tied to the current
// cart/quantity, since it needs to make sense standalone on a listing page
// too. During the Azadi sale shipping is free on every order with no
// threshold — see lib/saleTheme.ts for the sale window.
